(function (root, factory) {
    ...
    function getUrlsFromSitemap(sitemapURL,blacklist){
    ...
    module.scrape = function(config){
        ...
        if(!config.url){
            ...
            if(mappingErrors.length > 0){
                ...
                (function(urlArray,config){
                    ...
                    if(!Array.isArray(urlArray)){
                        ...
                        if(urlArray.indexOf(".xml") == urlArray.length - 4){
                            //this is a sitemap!
                            return getUrlsFromSitemap(urlArray,config.blacklist);
                        }else{
                            urlArray = [urlArray];
                ...
                })(urlArray,config).then(function(urlArray){
                    Squad.run(urlArray,function(url){
                        ...
                        if(config.verbose){
                            console.log("Cheers : Scraping "+url);
                        }
